...
console.log(`  players ${players.length} · shops ${shops.length} · inventory ${inventory.length} · creations ${creations.length} · messages ${messages.length} · trades ${trades.length}`);
